...
class BackboneUserEncoder(BaseModel):
    ...
    def __init__(
        ...
        self.feedbackEncoder = nn.Linear(self.feedback_dim, state_transformer_enc_dim)
        ...
        self.itemFeatureKernel = nn.Linear(state_item_latent_dim, state_transformer_enc_dim)
        self.userFeatureKernel = nn.Linear(state_user_latent_dim, state_transformer_enc_dim)
        ...
        encoder_layer = nn.TransformerEncoderLayer(d_model=2*state_transformer_enc_dim, 
                                                   ...
                                                   batch_first = True)
        self.transformer = nn.TransformerEncoder(encoder_layer, num_layers=state_transformer_n_layer)
