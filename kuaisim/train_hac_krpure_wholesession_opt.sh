...
log_name="user_KRMBUserResponse_lr0.0001_reg0.0001_nlayer2"
                ...
                do
                    ...
                    do
                        ...
                        do
                            ...
                            python train_actor_critic_opt.py\
                                --env_class ${ENV_CLASS}\
                                ...
                                --potential_hidden_dims 256 256\
                                --potential_dropout_rate 0.1\
                                ...
                                --batch_size ${BS}\
                                --critic_lr ${CRITIC_LR}\
                                --behavior_lr 0.0000001\
                                --behavior_decay 0.00000001\
                                --critic_decay ${REG}\
