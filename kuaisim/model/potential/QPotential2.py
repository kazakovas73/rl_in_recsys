...
from model.components import DNN2
from utils import get_regularization

class QPotential2(nn.Module):
    @staticmethod
    def parse_model_args(parser):
        ...
        - critic_dropout_rate
        '''
        parser.add_argument('--potential_hidden_dims', type=int, nargs='+', default=[128], 
                            help='specificy a list of k for top-k performance')
        parser.add_argument('--potential_dropout_rate', type=float, default=0.1, 
    ...
    def __init__(self, args, environment, policy):
        ...
        self.net = DNN2(self.state_dim + self.action_dim, args.critic_hidden_dims, 1, 
