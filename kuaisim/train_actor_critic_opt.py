...
if __name__ == '__main__':
    ...
    init_parser.add_argument('--potential_class', type=str, required=True, help='Potential class')
    ...
    potentialClass = eval('{0}.{0}'.format(initial_args.potential_class))
    ...
    parser = potentialClass.parse_model_args(parser)
    ...
    potential = potentialClass(args, env, policy)
    potential.to(device)
